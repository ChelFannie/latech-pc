<template>
  <div class="release-ticket">
    <el-form ref="form" :model="form" size="mini" label-width="110px" class="grayLayout">
      <div class="title">查看票券</div>
      <div class="ticketInfo">
        <div class="sub_title">查看票券信息</div>
      ...
      <div class="statisticalRecord">
        <el-row>
          <el-col :span="24" style="border: 1px solid #000;margin:8px 0;"></el-col>
        </el-row>
        <div class="sub_title">票券统计记录</div>
        <el-table ref="multipleTable" border :data="statisticalData" tooltip-effect="dark" style="width: 52.5%">
          <el-table-column v-for="(item, index) in statisticalColumn" :key="index" :prop="item.prop" :label="item.label" :width="item.width">
          </el-table-column>
        </el-table>
      </div>
      <div class="ticketRecord">
        ...
        <div class="sub_title">票券修改记录</div>
        <el-table ref="multipleTable" border :data="modifyData" tooltip-effect="dark" style="width: 25%">
          <el-table-column v-for="(item, index) in modifyColumn" :key="index" :prop="item.prop" :label="item.label" :width="item.width">
          </el-table-column>
        </el-table>
      </div>
      <div class="releaseBtn" style="text-align: center;">
        <el-button type="primary" size="small">修改</el-button>
        <el-button type="primary" size="small">导出票券领取使用记录</el-button>
...
export default {
  data () {
    return {
      ...
      activeData: [],
      statisticalColumn: [
        { prop: 'totalRelease', label: '发放总量', width: '125' },
        { prop: 'received', label: '已领取', width: '125' },
        { prop: 'used', label: '已使用', width: '125' },
        { prop: 'totalConsumption', label: '使用订单消费总额', width: '150' }
      ],
      statisticalData: [],
      modifyColumn: [
        { prop: 'totalRelease', label: '票券修改人', width: '125' },
        { prop: 'received', label: '修改时间', width: '125' }
      ],
      modifyData: []
    }
  },
