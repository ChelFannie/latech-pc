  ...
  <div class="add-store">
    <i-layout :head="true" :gray="true">
      <div slot="grayLayout">
        ...
        <el-table :data="tableData" border style="width: 41.5%" @select="checkSelect">
          <el-table-column type="selection" width="55" align="center">
          </el-table-column>
          <el-table-column prop="terminalCode" label="设备唯一码" width="180" align="center">
          </el-table-column>
          <el-table-column prop="terminalPWD" label="设备终端密码" width="180" align="center">
          </el-table-column>
        </el-table>
        <div class="operate">
  ...
  methods: {
    ...
    submitMachine () {
      if (!this.addMachineForm.terminalCode || !this.addMachineForm.terminalPWD) {
        ...
        if (index === -1) {
          this.dialogVisible = false
          this.tableData.push({ terminalCode: this.addMachineForm.terminalCode, terminalPWD: this.addMachineForm.terminalPWD })
        } else {
          this.addMachineForm.terminalCode = ''
          this.$message({
            type: 'warning',
