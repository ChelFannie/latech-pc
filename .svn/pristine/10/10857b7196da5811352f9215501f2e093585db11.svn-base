<template>
  <div class="add-ticket-management">
    <el-form ref="form" :model="form" size="mini" label-width="110px" class="grayLayout">
      <div class="title">新增票券</div>
      <div class="ticketInfo">
        <div class="sub_title">新增票券信息</div>
      ...
      <div class="connectedActive">
        ...
        <div class="content clearfix">
          <el-form-item label="关联活动名称">
            <el-input v-model="form.connectedActive.name" suffix-icon="el-icon-search" @change="searchActive"></el-input>
          </el-form-item>
          <el-form-item label="关联活动编码">
            <el-input v-model="form.connectedActive.code"></el-input>
          </el-form-item>
        </div>
      </div>
      <div class="ticketBtn" style="text-align: center;">
        ...
        <router-link to="ticket-management"><el-button size="small">关闭</el-button></router-link>
      </div>
    </el-form>
